...
Thread_obj::Thread_obj()
{
    ...
    arguments_cpu<<g_sWorkingPath + "/Scripts/flush_percent/cpu_rate.sh";
    arguments_mem<<g_sWorkingPath + "/Scripts/flush_percent/mem_rate.sh";
    arguments_top<<g_sWorkingPath + "/Scripts/flush_percent/cpu-mem.sh";
    /*设置定时器*/
    timer->start(2000);
}
