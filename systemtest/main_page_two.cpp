...
void My_Obj_Flush_Cpu::Flush_cpu_info()
{
    ...
    arguments<<g_sWorkingPath + "/Scripts/cpu_show/cpu_show2.sh";
...
void My_Obj_Test_Cpu::start_test_cpu()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/cpu_show/cpu_cal_rate.sh";
    proc->start(program, arguments);
...
void Main_Page_two::re_test_cpu_1_slots()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/cpu_show/cpu_show1.sh";
