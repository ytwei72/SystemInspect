...
void My_Obj_udp_tcp::start_timer()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/2/tcp_udp.sh";
    proc->start(program, arguments);
    if(!proc->waitForStarted())
    {
        return;
...
void My_Obj_Net_Flow::Net_Flow_wire(QString arg)
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/2/ethavgflow.sh"<<arg;
    proc->start(program, arguments);
    if(!proc->waitForStarted())
    {
        return;
...
void My_Obj_Net_Flow::Net_Flow_wireless(QString arg)
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/2/wlanavgflow.sh"<<arg;
    proc->start(program, arguments);
    if(!proc->waitForStarted())
    {
        return;
...
void Main_Page_five::re_test_net_slots()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/1/netinfo.sh";
...
void Main_Page_five::more_detail_for_net_slots()
{
    ...
    else if(Flag_Read_Pwd == 1)
    {
        QString Program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/netinfo/1/netinfosu.sh"<<PWD;
        pro->start(Program, arguments);
...
void Main_Page_five::test_network()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/2/test_netlink.sh";
    pro->start(program, arguments);
...
void Main_Page_five::re_test_safe_slots()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/3/net_secure.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void Main_Page_five::more_detail_for_safe_slots()
{
    ...
    else if(Flag_Read_Pwd == 1)
    {
        QString Program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/netinfo/3/firewall.sh"<<PWD;
        pro->start(Program, arguments);
        while(pro->waitForFinished())
        {
            out += pro->readAll();
...
void Main_Page_five::show_wire_msg()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/4/eth.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void Main_Page_five::show_wireless_msg()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/netinfo/4/wlan.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
