...
//    timer = new QTimer();
    proc = new QProcess();
    /*qlist一键测评要执行的脚本*/
    qlist<<g_sWorkingPath + "/Scripts/sys_test/arp_secure.sh"<<g_sWorkingPath + "/Scripts/sys_test/checkdisk.sh"<<g_sWorkingPath + "/Scripts/sys_test/cpu_hyper.sh"<<g_sWorkingPath + "/Scripts/sys_test/cpu_iowait.sh"
           <<g_sWorkingPath + "/Scripts/sys_test/cpu_run_threads.sh"<<g_sWorkingPath + "/Scripts/sys_test/cpu_sys_rate.sh"<<g_sWorkingPath + "/Scripts/sys_test/cpu_user_rate.sh"<<g_sWorkingPath + "/Scripts/sys_test/cpu_virtual.sh"
           <<g_sWorkingPath + "/Scripts/sys_test/earntime.sh"<<g_sWorkingPath + "/Scripts/sys_test/firefox_cookies.sh"<<g_sWorkingPath + "/Scripts/sys_test/google_cookies.sh"<<g_sWorkingPath + "/Scripts/sys_test/google_history.sh"
          <<g_sWorkingPath + "/Scripts/sys_test/init_arp.sh"<<g_sWorkingPath + "/Scripts/sys_test/io_await.sh"<<g_sWorkingPath + "/Scripts/sys_test/io_reqnum.sh"<<g_sWorkingPath + "/Scripts/sys_test/io_svctm.sh"<<g_sWorkingPath + "/Scripts/sys_test/io_util.sh"
          <<g_sWorkingPath + "/Scripts/sys_test/junk_files.sh"<<g_sWorkingPath + "/Scripts/sys_test/mem_user.sh"<<g_sWorkingPath + "/Scripts/sys_test/recent_used.sh";
...
//        timer->stop();
    ...
    ret = "";
    QStringList arg_ret;
    arg_ret<<g_sWorkingPath + "/Scripts/sys_test_result/show_result.sh"<<argus.at(n)<<getout;
