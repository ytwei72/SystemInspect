...
MyTreeModel::MyTreeModel(const QStringList &headers, const QString &data, QObject *parent)
...
bool MyTreeModel::insertColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool MyTreeModel::insertRows(int position, int rows, const QModelIndex &parent)
{
    TreeItem *parentItem = getItem(parent);
    bool success;
...
bool MyTreeModel::removeColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool MyTreeModel::removeRows(int position, int rows, const QModelIndex &parent)
{
    TreeItem *parentItem = getItem(parent);
    bool success = true;
...
void MyTreeModel::setupModelData(const QStringList &lines, TreeItem *parent)
{
