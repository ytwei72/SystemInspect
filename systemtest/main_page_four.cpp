...
void My_Obj_Disk_Test::start_timer()
{
    ...
    arguments<<g_sWorkingPath + "/Scripts/disk/disktool/disk_hdparm.sh"<<PWD;
...
void My_Obj_Dd_Test::start_test()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/disk/disktool/dd_test.sh"<<PWD;
    proc->start(program, arguments);
    if(!proc->waitForStarted())
    {
        return;
...
void Main_Page_four::re_test_disk_slots()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/disk/diskinfo.sh";
...
void Main_Page_four::more_detail_slots()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/diskinfosu.sh"<<PWD;
...
void Main_Page_four::judge_hddtemp()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/disk/disktool/hddtemp_judge.sh";
    pro->start(program, arguments);
...
void Main_Page_four::check_hddtemp()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/hddtemp_tool.sh"<<PWD;
        pro->start(program, arguments);
...
void Main_Page_four::install_hddtemp()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/hddtemp_install.sh"<<PWD;
        pro->start(program, arguments);
        while(!pro->waitForFinished(0))
        {
        }
...
void Main_Page_four::remove_hddtemp()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/hddtemp_remove.sh"<<PWD;
        pro->start(program, arguments);
        while(!pro->waitForFinished(0))
        {
        }
...
void Main_Page_four::re_test_io_slots()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/disk/io_diskstats.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void Main_Page_four::init_widget_4_bash()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/disk/disktool/sysstat_judge.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out = pro->readAll().trimmed();
...
void Main_Page_four::install_sysstat()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/sysstat_install.sh"<<PWD;
        pro->start(program, arguments);
        while(!pro->waitForFinished(0))
        {
        }
...
void Main_Page_four::remove_sysstat()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/sysstat_remove.sh"<<PWD;
        pro->start(program, arguments);
        while(!pro->waitForFinished(0))
        {
        }
...
void Main_Page_four::check_sysstat()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/disk/disktool/iostat_tool.sh"<<PWD;
        pro->start(program, arguments);
