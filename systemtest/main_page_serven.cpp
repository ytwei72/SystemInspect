...
void main_page_serven::user_show_1()
{
    ...
    arguments<<g_sWorkingPath + "/Scripts/security/1/1.sh";
...
void main_page_serven::user_show_2()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/security/1/2.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void main_page_serven::dentry()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/security/2/1.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void main_page_serven::compare()
{
    ...
    QString program = "bash";
    QStringList arguments;
    arguments<<g_sWorkingPath + "/Scripts/security/2/2.sh";
    pro->start(program, arguments);
    while(pro->waitForReadyRead())
    {
        out += pro->readAll();
...
void main_page_serven::show_edit_1()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/3/part1.sh"<<PWD;
        pro->start(program, arguments);
        ...
        arguments1<<g_sWorkingPath + "/Scripts/security/3/part2.sh"<<PWD;
        ...
        arguments2<<g_sWorkingPath + "/Scripts/security/3/part3.sh"<<PWD;
...
void main_page_serven::check1()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/4/part1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
        while(true == pro->waitForFinished())
        {
...
void main_page_serven::compare1()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/4/test1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
       while(true == pro->waitForFinished())
        {
...
void main_page_serven::check2()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/5/part1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
        while(true == pro->waitForFinished())
        {
...
void main_page_serven::compare2()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/5/test1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
       while(true == pro->waitForFinished())
        {
...
void main_page_serven::check3()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/6/part1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
        while(true == pro->waitForFinished())
        {
...
void main_page_serven::compare3()
{
    ...
    else if( Flag_Read_Pwd == 1)
    {
        ...
        QString program = "bash";
        QStringList arguments;
        arguments<<g_sWorkingPath + "/Scripts/security/6/test1.sh"<<PWD;
        //pro = new QProcess();
        pro->start(program, arguments);
       while(true == pro->waitForFinished())
        {
